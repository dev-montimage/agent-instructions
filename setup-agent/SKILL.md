...
2. Claude analyzes the project:
   ...
   - Uses AskUserQuestion to resolve any ambiguities
3. Claude writes `agent-instructions.md`:
   - Documents Phase 1 (Research) instructions for future agents
   - Documents Phase 2 (Plan) instructions for future agents
   - Documents Phase 3 (Execute) instructions for future agents
   - Includes all necessary commands and verification steps
   - Adds success criteria and rollback strategies
4. Claude reports completion:
   - Confirms `agent-instructions.md` has been created
   - Explains how to use it with any AI agent

## Best Practices

- Use the TodoWrite tool to track your analysis and writing progress
- Use AskUserQuestion to resolve any ambiguities you find
- Focus on writing clear, executable instructions for future agents
- Do NOT execute the installation yourself - you're writing the manual, not following it
- Provide specific commands and verification steps in the documentation
- Make the instructions autonomous so future agents need minimal human intervention
